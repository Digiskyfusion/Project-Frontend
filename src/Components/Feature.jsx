...
function Feature() {
  const steps = [
    ...
    { id: 2, title: "Earn Securely. Get Paid On Time.", desc: "Transparent transactions, zero stress.", img:feature2 },
    { id: 3, title: "Talk. Collaborate. Deliver. ", desc: " Instant messaging for smooth communication.", img: feature3 },
