...
function Calltoaction() {
  return (
    <section className="flex flex-col items-center text-black py-16 px-4 rounded-2xl shadow-lg">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mt-8 md:mt-0 ml-32 " >
