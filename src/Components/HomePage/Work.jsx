...
function Work() {
  ...
  const content = {
    client: [
      { img: joboffer, title: 'Search Freelancer', text: 'Search freelancers by category, describe your project, set your budget, and hire the best talent.', route: '/client' },
      { img: jobpost, title: 'Connect with Experts', text: 'Browse top-rated freelancers, check their work, and hire with confidence.', route: '/Freelancer-Profile' },
      { img: workdone, title: 'Get Work Done', text: 'Track progress, communicate easily, and receive high-quality results.', route: '/chat' }
    ],
    freelancer: [
      { img: first, title: 'Create a Winning Profile', text: 'Highlight your skills, experience, and portfolio.', route: "/Profileverification" },
