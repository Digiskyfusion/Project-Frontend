...
const MembershipPlans = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-gradient-to-r from-gray-100 via-gray-300 to-gray-100">
      ...
      {message && <p className="text-red-500 mb-6 font-medium">{message}</p>}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
        {plans.map((plan, index) => (
          ...
          >
              ...
              <>
                {plan.name === "Basic" && (
                  <ul className="text-sm mt-2 space-y-1">
                    <li>
                      ✅ Unlimited work and link uploads to showcase your
                      talent.
                    </li>
                    <li>
                      ✅ Boost your visibility and increase your chances of
                      getting hired.
                    </li>
                  </ul>
                )}
                ...
                {plan.name === "Standard" && (
                  <ul className="text-sm mt-2 space-y-1">
                    ...
                    <li>
                      ✅ Access to chat — connect directly with clients or
                      freelancers.
                    </li>
                    <li>
                      ✅ Featured placement — get your profile and work
                  ...
                  <ul className="text-sm mt-2 space-y-1">
                    ...
                    <li>
                      ...
                      <span className="italic font-semibold px-2 py-1 rounded">
                        Your own personalized portfolio with a custom domain
                        name.
                      </span>
                    </li>

                    <li>
                      ✅ Stand out and share your work with a professional
                      presence anywhere.
                    </li>
                  </ul>
                )}
              ...
              <>
                ...
                {plan.name === "Standard" && (
                  <ul className="text-sm mt-2 space-y-1">
                    ...
                    <li>
                      ✅ Access to chat — connect directly with freelancers.
                    </li>
                  </ul>
                )}
                ...
                {plan.name === "Premium" && (
                  <ul className="text-sm mt-2 space-y-1">
                    ...
                    <li>
                      ✅ Featured placement — get your profile and job
                      highlighted at the top.
                    </li>
                  </ul>
                )}
            ...
            <button
              className={`mt-4 py-2 px-5 cursor-pointer bg-[#004930] text-white rounded-full transition duration-300 ${
                plan.name === "Premium"
