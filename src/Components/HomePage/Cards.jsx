...
const Cards = () => {
  const plans = [
    { name: "Basic", credit: 10, amount: 199 },
    { name: "Standard", credit: 50, amount: 499 },
    { name: "Premium", credit: 100, amount: 799 },
  ];
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/FreelancerUpadte"), 1500);
    } catch (error) {
    ...
    <div className="flex flex-col items-center p-8 bg-gradient-to-r from-gray-100 via-gray-300 to-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
        {plans.map((plan, index) => (
          ...
          >
            ...
            <h3 className="text-3xl font-bold mt-4 flex items-center"><FaRupeeSign />
            {plan.amount}/month</h3>
      ...
      {selectedPlan && (
        ...
        >
          ...
          {/* <Link to="https://pages.razorpay.com/stores/st_Q8fQF0Lm2YaSFn"> */}
          <button
            type="submit"
