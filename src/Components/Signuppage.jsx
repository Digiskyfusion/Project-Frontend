      ...
      <div className="flex flex-col md:flex-row items-center justify-center p-3">
        <div className="p-5 w-full flex flex-col items-center md:w-1/2 md:py-5">
          ...
          <div className="flex justify-center gap-4 mb-4">
            ...
            <button className="px-6 py-1 md:px-10 rounded-full cursor-pointer border-2 bg-[#004930] text-white border-[#004930]">
              Sign Up
            </button>
          </div>
...
<button className="bg-[#004930] text-white py-2 px-6 md:px-10 rounded-full cursor-pointer">Sign Up</button>
            ...
            <div className="flex flex-col items-center justify-center gap-4 mt-6">
                <button 
                  className="flex items-center justify-center gap-2 w-full max-w-[400px] bg-[#004930] text-white md:px-20 py-2 px-8 rounded-full"
                >
