  ...
  "TV Channel Ad": [
    {
      ...
      role: "TV Ad Manager",
      image: image3,
      description: "Expert in TV ad placements and strategy.",
    },
    {
      name: "Robert Brown",
      role: "Media Buyer",
      image: image8,
      description: "Negotiates and purchases ad slots for clients.",
    },
    {
      name: "Sophia Martinez",
      role: "Ad Producer",
      image: image10,
      description: "Creates compelling TV advertisements.",
    },
  ],
  "Content Marketing": [
    {
      ...
      image: image0,
      description: "Specialist in long-form content & blogging.",
    },
    {
      name: "Mia Davis",
      role: "Copywriter",
      image: image1,
      description: "Expert in engaging and SEO-optimized content.",
    },
    {
      name: "Noah Wilson",
      role: "Marketing Analyst",
      image: image2,
      description: "Analyzes content effectiveness and audience.",
    },
  ],
  "Email Marketing": [
    {
      ...
      image: image5,
      description: "Runs high-converting email campaigns.",
    },
    {
      name: "James Anderson",
      role: "Automation Specialist",
      image: imagesss,
      description: "Expert in email sequences & automation.",
    },
    {
      name: "Emma White",
      role: "Lead Nurturing Expert",
      image: image6,
      description: "Focuses on customer retention & conversion.",
    },
  ],
  "Pay-per-click (PPC)": [
    {
      ...
      role: "PPC Specialist",
      image: image7,
      description: "Manages Google Ads and Bing Ads campaigns.",
    },
    {
      name: "Emily Clark",
      role: "Ad Optimization Expert",
      image: image8,
      description: "Improves ad performance & lowers costs.",
    },
    {
      name: "Daniel Scott",
      role: "Keyword Researcher",
      image: image9,
      description: "Finds high-converting PPC keywords.",
    },
  ],
  "Influencer Marketing": [
    {
      ...
      image: image11,
      description: "Connects brands with the right influencers.",
    },
    {
      name: "Benjamin Lee",
      role: "Social Media Strategist",
      image: image12,
      description: "Builds influencer-driven marketing plans.",
    },
    {
      name: "Isabella Brown",
      role: "Brand Partnership Manager",
      image: image1,
      description: "Develops collaborations with creators.",
    },
  ],
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {obj.map((item, index) => (
          ...
          >
            ...
            >
              <Link
                to={item.Tv === "TV Channel Ad" ? "/channel" : "/detailpage"}
                state={{ category: item.Tv }}
              >
                See Details
              </Link>
            </button>
