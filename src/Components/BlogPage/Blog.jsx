    ...
    <>
      <div className="bg-white text-gray-800 min-h-screen flex flex-col">
        ...
        <section className="text-center py-20 bg-gradient-to-r from-[#d1fae5] to-[#f0fdfa] px-4 md:px-8">
          ...
          <Link to="/">
            <button className="mt-8 bg-[#065f46] text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-[#047857] transition">
              Read Our Insights
            </button>
          </Link>
        </section>
          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col justify-between flex-grow">
                ...
                <div className="mt-5">
                  <Link to={`/blog/${index}`}>
                    <button className="w-full bg-[#065f46] text-white px-5 py-2 rounded-full font-medium hover:bg-[#047857] transition">
                      Read More
                    </button>
                  </Link>
                </div>
