...
function Loginform() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Ensure navigation happens after a slight delay
        setTimeout(() => {
  ...
  return (
    <div className="w-full py-5 flex items-center justify-center bg-gray-100 px-24">
      <div className="w-full bg-white rounded-lg shadow-lg px-4 py-5 md:py-10 md:px-10 flex gap-4 flex-col md:flex-row items-center">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="flex justify-center gap-4 mb-2">
            <button className="px-6 py-1 md:px-10 rounded-full cursor-pointer border-2 bg-[#004930] text-white  border-[#004930]" onClick={() => navigate("/login")}>Login</button>
            <button className="px-6 py-1 md:px-10 rounded-full cursor-pointer border-2  border-[#004930]" onClick={() => navigate("/registration")}>Sign Up</button>
          </div>
...
<Toaster />
          <form className="w-full flex flex-col gap-4" onSubmit={handleLoginSubmit}>
            ...
            <div className="relative w-full">
              ...
              <input type="password" name="password" value={loginForm.password} onChange={handleChangeLogin} placeholder="Enter password" className="w-full p-3 border rounded-lg pl-10" required />
            </div>
            <div className="">
        ...
        <div className="w-full hidden md:flex justify-center">
          <img src={newonw} alt="Login" className="" />
        </div>
      </div>
    </div>
  );
